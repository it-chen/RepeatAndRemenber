...
.controller('N1', function($scope, $ionicSideMenuDelegate,N1Units,$stateParams,$ionicPopup) {

  $scope.units = N1Units.all();
  $scope.totlePage = N1Units.totlePage();
  $scope.abc = new Array();
  ...
  $scope.itemNo = 1;
  $scope.item = N1Units.get($scope.unitNo,$scope.itemNo);
